import { START_GAME, NEXT_GAME, START_COUNTDOWN, STOP_COUNTDOWN, MODIFY_SCORE, SWITCH_PLAYER, INITIALIZE_GAME, PLAYER_ELIMINATED } from './actions'
...
export const playerEliminated = () => ({ type: PLAYER_ELIMINATED, payload: { } })
